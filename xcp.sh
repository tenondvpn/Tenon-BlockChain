...
do
    ...
    sshpass -p Xf4aGbTaf9 scp -o "StrictHostKeyChecking no" ./cbuild_Debug/tenon root@$ip:/root/tenon/tenon_s
    sshpass -p Xf4aGbTaf9 scp -o "StrictHostKeyChecking no" ./cbuild_Debug/tenon root@$ip:/root/n1/tenon1
    sshpass -p Xf4aGbTaf9 scp -o "StrictHostKeyChecking no" ./cbuild_Debug/tenon root@$ip:/root/n2/tenon2
    sshpass -p Xf4aGbTaf9 scp -o "StrictHostKeyChecking no" ./cbuild_Debug/tenon root@$ip:/root/n3/tenon3
    sshpass -p Xf4aGbTaf9 scp -o "StrictHostKeyChecking no" ./cbuild_Debug/tenon root@$ip:/root/n4/tenon4
done
