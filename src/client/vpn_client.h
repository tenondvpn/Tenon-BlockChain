...
struct TxInfo {
    TxInfo(
            ...
            const bft::protobuf::BlockPtr& in_block)
    ...
    bft::protobuf::BlockPtr block_ptr;
};
...
private:
    ...
    void HandleBlockResponse(const block::protobuf::GetTxBlockResponse& block_res);
    ...
    std::unordered_map<std::string, bft::protobuf::BlockPtr> tx_map_;
