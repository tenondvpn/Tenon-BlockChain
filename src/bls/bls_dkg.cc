...
void BlsDkg::BroadcastFinish(const common::Bitmap& bitmap) {
    ...
    BLS_DEBUG("Finish new election block elect_hegiht_: %lu, local_member_index_: %d, sec_key: %s, cpk: %s, %s, %s, %s, pk: %s, %s, %s, %s, msg_hash: %s, signxy: %s, %s",
        ...
        common::Encode::HexEncode(common_pk->x_c0()).c_str(),
        common::Encode::HexEncode(common_pk->x_c1()).c_str(),
        common::Encode::HexEncode(common_pk->y_c0()).c_str(),
        common::Encode::HexEncode(common_pk->y_c1()).c_str(),
        common::Encode::HexEncode(local_pk->x_c0()).c_str(),
        common::Encode::HexEncode(local_pk->x_c1()).c_str(),
        common::Encode::HexEncode(local_pk->y_c0()).c_str(),
        common::Encode::HexEncode(local_pk->y_c1()).c_str(),
