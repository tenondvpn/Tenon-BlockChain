...
console.log("giveRightToVote function code: " + giveRightToVoteCode);

var delegateCode = web3.eth.abi.encodeFunctionSignature('delegate(address)');
console.log("delegateCode function code: " + delegateCode);

var voteCode = web3.eth.abi.encodeFunctionSignature('vote(uint256)');
console.log("voteCode function code: " + voteCode);

var winningProposalCode = web3.eth.abi.encodeFunctionSignature('winningProposal()');
console.log("winningProposalCode function code: " + winningProposalCode);

var winnerNameCode = web3.eth.abi.encodeFunctionSignature('winnerName()');
console.log("winnerName function code: " + winnerNameCode);

// 2345675643000000
var voteParam = web3.eth.abi.encodeParameters(['uint256'], ['1']);
console.log("voteParam: " + voteParam);

var call_claimPaiment_param_codes = web3.eth.abi.encodeParameters(['address'], ['0x953928cb519f5706111240aad891db442208c27d']);
...
console.log("constructorCodes: " + constructorCodes);
