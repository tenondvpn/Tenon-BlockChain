...
/* Object interface: IMyClass, ver. 0.0,
   GUID={0x10da1059,0xc1de,0x4036,{0x84,0xfb,0x3b,0xae,0x79,0x90,0x60,0x69}} */
...
CINTERFACE_PROXY_VTABLE(8) _IMyClassProxyVtbl = 
{
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IMyClass::TotalSum */
};
...
int __stdcall _MyCom_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _MyCom, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _MyCom, 2, *pIndex )
