...
EXTERN_C const IID IID_IMyClass;
    ...
    MIDL_INTERFACE("10da1059-c1de-4036-84fb-3bae79906069")
    IMyClass : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE TotalSum( 
            /* [in] */ LONG n,
            /* [out] */ LONG *sum) = 0;
    ...
    typedef struct IMyClassVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *TotalSum )( 
            IMyClass * This,
            /* [in] */ LONG n,
            /* [out] */ LONG *sum);
...
#define IMyClass_TotalSum(This,n,sum)	\
    ( (This)->lpVtbl -> TotalSum(This,n,sum) ) 
...
class DECLSPEC_UUID("fa998c86-13ca-42a7-9e46-a8c03973f7ce")
CompReg;
#endif
...
class DECLSPEC_UUID("f606ffcd-1eee-43ca-b7bb-db3c196e15e1")
MyClass;
#endif
