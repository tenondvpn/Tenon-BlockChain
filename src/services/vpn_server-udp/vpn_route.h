...
public:
    ...
    void SendStopServer(const struct sockaddr* des_addr, uint32_t server_id);
    void SendStreamData(server_t* server);
    uint32_t VlanNodeHeartbeat(
            uint32_t id,
